...
export const SpaceWeather = () => {
    ...
    return (
        <div className="w-full max-w-5xl mx-auto p-4 flex flex-col items-center animate-slide-in">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 w-full lg:items-stretch">
                ...
                <div className="lg:col-span-1 flex flex-col">
                    ...
                    <div className="p-6 rounded-2xl bg-slate-800/40 backdrop-blur-md border border-white/5 relative overflow-hidden group flex-1 flex flex-col justify-center">
            ...
            {/* Observer Location - Below Grid */}
            <div className="w-full max-w-5xl mt-8">
                <div className="lg:w-[calc((100%-4rem)/3)] p-6 rounded-2xl bg-slate-800/20 border border-white/5">
